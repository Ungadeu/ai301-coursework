...
Accept the issue if every required check passes. The preferred checks do not alter the final verdict and are only used to rank the accepted issues. Any unclear result on a required check is treated as a fail.
