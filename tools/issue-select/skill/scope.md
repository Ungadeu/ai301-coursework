...
I have hands-on experience developing applications using Python, Git, and Streamlit, as well as working with vector embeddings in ChromaDB and Retrieval-Augmented Generation (RAG) pipelines. I want to get better at writing robust unit tests, managing complex collaborative Git workflows, and integrating AI models into existing codebases. I prefer to avoid heavy front-end UI design tasks, focusing instead on backend logic, applied AI tool development, and data architecture.
